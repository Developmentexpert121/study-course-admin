...
import {  SearchIcon, Image as ImageIcon, Video } from "lucide-react";
      ...
      {chapters.length > 0 ? (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {chapters.map((chapter: any) => (
            <div
              key={chapter.id}
               onClick={()=> router.push(`/user-panel/code/codingquestionbychapter?course_id=${courseId}&chapter_id=${chapter.id}`)}
