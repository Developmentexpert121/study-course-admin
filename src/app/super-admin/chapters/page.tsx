...
export default function Chapters({ className }: any) {
  ...
  const handleEdit = (id: number) => {
    setActiveDropdown(null);
    router.push(`/super-admin/chapters/edit-chapters?id=${id}`);
  };
  ...
  const handleAddLessons = (chapterId: number) => {
    setActiveDropdown(null);
    router.push(
      `/super-admin/lessons/list?course_id=${courseId}&chapter_id=${chapterId}`,
    );
  };
  ...
  const handleAddMCQs = (chapterId: number) => {
    setActiveDropdown(null);
    router.push(
      `/super-admin/mcq?chapter_id=${chapterId}&course_id=${courseId}&name=${courseName}`,
    );
  };
      ...
      <div className="mb-4 flex items-center justify-between">
        ...
        <div className="flex w-full flex-col gap-3 sm:w-auto sm:flex-row sm:items-center">
          ...
          <button
            onClick={() =>
              router.push(
                `/super-admin/chapters/add-chapters?course_id=${courseId}&course=${courseName}`,
              )
            }
