...
const EditCourse = ({ basePath }: EditCourseProps) => {
                            ...
                            <div className="relative">
                                <div className="flex gap-2">
                                    ...
                                    <button
                                        ...
                                        className="flex items-center gap-2 rounded-lg bg-[#015379] px-4 py-3 text-white hover:bg-[#01537969] disabled:cursor-not-allowed disabled:opacity-50"
                                    >
