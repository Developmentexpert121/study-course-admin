    ...
    >
      ...
      <div className="relative z-10 mx-auto max-w-3xl px-4 text-center ">
        ...
        <p className="text-xl text-white mb-8">
               Learn step by step with practical training and earn a certification that adds value to your profile. Gain confidence through hands-on learning designed for real career growth.
            </p>
