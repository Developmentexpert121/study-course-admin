      ...
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-16 px-6 lg:px-12">
        ...
        <div className="lg:w-1/2">
          ...
          <p className="text-lg text-gray-600 mb-8 leading-relaxed">
            Learn from anywhere and grow at your own pace with DevexHub. Our online remote learning lets you build in-demand skills quickly and effectively, without being tied to a classroom. Each course is designed to be practical and easy to follow, so learning feels simple, focused, and enjoyable. DevexHub supports you with guidance, direction, and mentoring to help you move forward with clarity and confidence.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            ...
            <div className="flex items-start space-x-4 p-4 bg-orange-50 rounded-xl hover:bg-orange-100 transition-colors card-hover">
              ...
              <div>
                <h3 className="font-bold text-gray-900 mb-1">Career Support & Guidance</h3>
